...
EMAIL_HOST_USER = 'trinidad.antonnikolai.p.5463@gmail.com'
EMAIL_HOST_PASSWORD = 'xmthueweawiehpii'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_BACKEND = CKEND = 'django.core.mail.backends.smtp.EmailBackend'
ALLOWED_HOSTS = []
