...
class EditProfileView(UpdateView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            add_activity(logged_user=self.request.user,activity_type='UPDATE EMPLOYEE',activity_location='ADMIN',activity_message=f"{self.object.first_name} {self.object.last_name}has been successfully updated.")
        except Http404:
